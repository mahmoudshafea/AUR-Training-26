...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/user/AUR_sessions/ROSsession/ros_ws/src/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/home/user/AUR_sessions/ROSsession/ros_ws/.pixi/envs/default/bin/python3.12"
